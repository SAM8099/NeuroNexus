...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            logging.info('Read the Titanic dataset as dataframe')

            # Basic preprocessing for Titanic dataset
            logging.info('Performing basic preprocessing on Titanic dataset')
            ...
            logging.info("Ingestion of the Titanic data is completed")
